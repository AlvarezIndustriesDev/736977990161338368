    ...
    if (array[i].length) {
      ...
      for (var j = 0; j < array[i].length; j = j + delta) {
        ...
        if ((finalElementsArray.length < limit) && elementsRemaining > 0) {
          ...
          // execute if selected element is near a video element
